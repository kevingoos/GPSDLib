...
msbuild GPSDLib\GPSDLib.sln /t:Rebuild /p:Configuration=Release

ECHO "Exporting packages"
IF "%nugetLocation%" equ "" (
	nuget pack GPSDLib\Ghostware.GPSDLib\Ghostware.GPSDLib.csproj -Prop Configuration=Release
) ELSE (
%nugetLocation%\nuget.exe pack GPSDLib\Ghostware.GPSDLib\Ghostware.GPSDLib.csproj -Prop Configuration=Release
)
